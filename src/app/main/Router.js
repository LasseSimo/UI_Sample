...
class AppRouter extends React.Component {
  ...
  constructor(){
    ...
    this.state = {
      index: 1,
      routes: [
        { key: '1', title: 'EXPLORE', icon:require('../images/icon/ic_explore_tab.png') },
        { key: '2', title: 'CLIENTS',icon:require('../images/icon/ic_client_tab.png') },
        { key: '3', title: 'INBOX',icon:require('../images/icon/ic_inbox_tab.png') },
        { key: '4', title: 'PROFILE',icon:require('../images/icon/ic_profile_tab@2x.png') },
        { key: '5', title: 'ACCOUNT',icon:require('../images/icon/ic_account_tab.png') },
      ],
    }
  }
